...
module.exports = async (context) => {
    ...
    if (!text.includes('|')) {
        return m.reply("Example Usage: * .deadpool Akio|Tech");
    }
    ...
    try {
        ...
        const apiUrl = `https://api.neoxr.eu/api/deadpool?text1=${encodeURIComponent(text1)}&text2=${encodeURIComponent(text2)}&apikey=mcandy`;
